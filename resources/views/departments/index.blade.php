            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                        <a href="{{ route('departments.show', $department->id) }}" class="bg-green-600 text-white px-2 py-1 rounded-md hover:bg-green-700">See Employees</a>
                        <button type="button" onclick="showDeleteModal({{ $department->id }})" class="bg-red-600 text-white px-2 py-1 rounded-md hover:bg-red-700">Delete</button>
                    </td>
                </tr>
                @endforeach
            </tbody>
