    ...
    <div class="overflow-hidden shadow sm:rounded-lg">
        <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text -gray-900"><?php echo e($department->name); ?></td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900"><?php echo e($department->description); ?></td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                        <?php if($department->manager): ?>
                            <?php echo e($department->manager->name); ?>

                        <?php else: ?>
                            <span class="text-red-500">No manager assigned</span>
                        <?php endif; ?>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                        <a href="<?php echo e(route('departments.show', $department->id)); ?>" class="bg-green-600 text-white px-2 py-1 rounded-md hover:bg-green-700">See Employees</a>
                        <button type="button" onclick="showDeleteModal(<?php echo e($department->id); ?>)" class="bg-red-600 text-white px-2 py-1 rounded-md hover:bg-red-700">Delete</button>
                    </td>
                </tr>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Youcode\Herd\hrsm\resources\views/departments/index.blade.php ENDPATH**/ ?>